...
execute = [(3, 'ver', iq_version, 2, 'Client version.'),
		   (3, 'ver+', iq_version_caps, 2, 'Client version with caps.'),
		   (3, 'caps', noiq_caps, 2, 'Show caps node and version of client.'),
		   (3, 'ping_old', ping, 2, 'Ping - reply time. You can ping nick in room, jid, server or transport.'),
		   (3, 'ping', urn_ping, 2, 'Ping - reply time. You can ping nick in room, jid, server or transport.'),
		   (3, 'time_old', iq_time, 2, 'Client side time.'),
		   (3, 'time', iq_utime, 2, 'Client side time.'),
		   (3, 'time_old_raw', iq_time_raw, 2, 'Client side time + raw time format.'),
		   (3, 'time_raw', iq_utime_raw, 2, 'Client side time + raw time format.'),
		   (3, 'stats', iq_stats, 2, 'Users server statistic.'),
		   ...
		   (3, 'uptime', iq_uptime, 2, 'Server or jid uptime.')]
